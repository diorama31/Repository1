	...
	$.fn.panorama = function(options) {
		this.each(function(){ 
			...
			panoramaContainer.css('height', elemHeight+'px').css('overflow', 'hidden').wrap("<div class='panorama-viewport'></div>").parent().css('width',settings.viewport_width+'px')
				.append("<div class='panorama-control'><a href='#' class='panorama-control-left'><img src='css/fancy_nav_left.png'/></a> <a href='#' class='panorama-control-pause'><img src='css/fancy_close.png'/></a> <a href='#' class='panorama-control-right'><img src='css/fancy_nav_right.png'/></a> </div>");
